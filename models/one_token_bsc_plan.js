...
const one_token_bsc_plan = new Schema({
...
one_token_bsc_plan.set('toJSON', { getters: true });
one_token_bsc_plan.options.toJSON.transform = (doc, ret) => {
  const obj = { ...ret };
  delete obj.__v;
  return obj;
};
module.exports = mongoose.model('one_token_bsc_plan', one_token_bsc_plan);
