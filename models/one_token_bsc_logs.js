...
const one_token_bsc_logs = new Schema({
...
one_token_bsc_logs.set('toJSON', { getters: true });
one_token_bsc_logs.options.toJSON.transform = (doc, ret) => {
  const obj = { ...ret };
  delete obj.__v;
  return obj;
};
module.exports = mongoose.model('one_token_bsc_logs', one_token_bsc_logs);
